        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="/success-stories" class="text-primary font-semibold relative group">
                        Success Stories
        ...
        <div class="relative max-w-7xl mx-auto px-4 text-center text-white">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-8">
                <div class="glass-effect rounded-lg px-6 py-3">
                    ...
                    <p class="font-semibold">Forever Homes</p>
                </div>
                <div class="glass-effect rounded-lg px-6 py-3">
                    <i class="fas fa-heart text-2xl mb-2"></i>
                    <p class="font-semibold">Love & Care</p>
                </div>
                <div class="glass-effect rounded-lg px-6 py-3">
                    <i class="fas fa-star text-2xl mb-2"></i>
                    <p class="font-semibold">Happy Endings</p>
                </div>
            </div>
            
            <div class="text-4xl font-bold mb-4 stat-card" data-aos="zoom-in" data-aos-delay="500">
                {{ $successStories->count() }} Happy Endings
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center fade-in-up" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="text-3xl font-bold text-gray-800 mb-2">{{ $successStories->count() }}</div>
                    <div class="text-gray-600">Stories</div>
                </div>
                <div class="text-center fade-in-up" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="text-gray-600">Adoption Rate</div>
                </div>
                <div class="text-center fade-in-up" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="text-3xl font-bold text-gray-800 mb-2">{{ $successStories->count() * 2 }}</div>
                    <div class="text-gray-600">Happy Families</div>
                </div>
                <div class="text-center fade-in-up" data-aos="fade-up" data-aos-delay="400">
                    <div class="w-16 h-16 bg-yellow-500/10 rounded-full flex items-center justify-center mx-auto mb-4 pulse-glow">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-16" data-aos="fade-up">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">
                    Heartwarming Transformation Stories
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Every story represents a journey from rescue to recovery, from abandonment to love, and from despair to hope
                </p>
            </div>
            ...
            @if($successStories->count() > 0)
                <div class="space-y-12">
                    @foreach($successStories as $story)
                        <div class="story-card bg-white rounded-2xl shadow-lg overflow-hidden {{ $story->featured ? 'ring-2 ring-primary' : '' }}" 
                             data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                            @if($story->featured)
                                <div class="absolute top-4 left-4 bg-primary text-white px-4 py-1 rounded-full text-sm font-semibold z-10">
                                    Featured Story
                                </div>
                            @endif
                            ...
                            <div class="md:flex">
                                ...
                                <div class="md:w-1/2 relative">
                                    <div class="before-after-container grid grid-cols-2 gap-2 p-6">
                                        <div class="space-y-2">
            ...
            <div class="text-center mt-16" data-aos="fade-up">
                <div class="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
                    ...
                    <p class="text-gray-600 mb-6">
                        Adopt a pet and give them the love and care they deserve. Your story could be the next one we share!
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="/medical-services" class="bg-gray-800 text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-700 transition-all duration-300 transform hover:scale-105">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">Success Stories</p>
                        </div>
                    </div>
                    <p class="text-gray-400">
                        Every success story represents hope, love, and the power of second chances.
                    </p>
                </div>
